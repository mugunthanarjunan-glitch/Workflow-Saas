...
export const createFinancialWorkflow = (data) => API.post('/workflows/financial', data);
...
export const getMyTasks = (page = 1, status = '', type = '') => API.get(`/tasks/my?page=${page}&status=${status}&type=${type}`);
